...
double OSUMANIA::FINGER_BALANCE::getSkill()
{
	return -1; /// \TODO
}

double OSUMANIA::FINGER_BALANCE::getDiff()
{
	return -1; /// \TODO
}
...
double OSUMANIA::FINGER_BALANCE::getTotalSkillAt(int _time)
{
	return -1; /// \TODO
}

double OSUMANIA::FINGER_BALANCE::getTotalDiffAt(int _time)
{
	return -1; /// \TODO
}
