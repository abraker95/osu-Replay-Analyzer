...
double OSUSTANDARD::TAPPING_CONTROL::getSkill()
{
	return -1; /// \TODO
}

double OSUSTANDARD::TAPPING_CONTROL::getDiff()
{
	return -1; /// \TODO
}
...
double OSUSTANDARD::TAPPING_CONTROL::getTotalSkillAt(int _time)
{
	return -1; /// \TODO
}

double OSUSTANDARD::TAPPING_CONTROL::getTotalDiffAt(int _time)
{
	return -1; /// \TODO
}