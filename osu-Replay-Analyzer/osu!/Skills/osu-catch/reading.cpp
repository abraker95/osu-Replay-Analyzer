...
double OSUCATCH::READING::getSkill()
{
	return -1; /// \TODO
}

double OSUCATCH::READING::getDiff()
{
	return -1; /// \TODO
}
...
double OSUCATCH::READING::getTotalSkillAt(int _time)
{
	return -1; /// \TODO
}

double OSUCATCH::READING::getTotalDiffAt(int _time)
{
	return -1; /// \TODO
}