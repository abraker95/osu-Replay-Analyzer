...
double OSUCATCH::PRECISION::getSkill()
{
	return -1; /// \TODO
}

double OSUCATCH::PRECISION::getDiff()
{
	return -1; /// \TODO
}
...
double OSUCATCH::PRECISION::getTotalSkillAt(int _time)
{
	return -1; /// \TODO
}

double OSUCATCH::PRECISION::getTotalDiffAt(int _time)
{
	return -1; /// \TODO
}
